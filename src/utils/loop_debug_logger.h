...
class LoopDebugLogger {
   public:
    struct Options {
        ...
        bool source_scan_accum_enable = false;
        int source_scan_accum_max_scans = 5;
        int source_scan_accum_min_scans = 3;
        double source_scan_accum_time_sec = 0.5;
        std::string source_scan_accum_ref = "current";
        std::string source_scan_accum_pose_type = "LIO";
        double source_scan_accum_max_trans_m = 1.2;
        double source_scan_accum_max_yaw_deg = 8.0;
        double source_scan_accum_voxel_leaf_m = 0.10;
        int source_scan_accum_max_points = 30000;
        int source_scan_accum_min_points = 3000;
        double source_scan_accum_max_yaw_rate_degps = 30.0;
        double source_scan_accum_max_trans_rate_mps = 2.5;
        bool source_scan_accum_require_monotonic_stamp = true;
        bool source_scan_accum_fallback_single = true;
        bool source_scan_accum_debug_enable = false;
        std::string source_scan_accum_debug_csv = "loop_source_scan_accum_debug.csv";
